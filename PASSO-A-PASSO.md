...
Este app agora tem **login com e-mail e senha** (usando o Firebase
...
5. **Configure as regras de segurança do Firestore**
   ...
   em si — e que a busca de e-mail (`email_lookup`, usada só para achar o
   UID de alguém na hora de compartilhar) só pode ser lida por quem já
   está logado, e cada pessoa só grava a própria entrada.
   Clique em **Publicar**.
...
Como o login já é feito com e-mail de verdade, "Esqueci a senha" na tela de
login funciona nativamente para qualquer conta — manda um link de
redefinição de verdade (usando o próprio Firebase). Também existe a opção
"Alterar senha", que pede a senha atual, caso prefira trocar sem depender
do e-mail.

### Compartilhar um prontuário com outra pessoa

No perfil de um animal, clique no ícone 🔗 (ao lado de editar/excluir) e
digite o **e-mail** da outra pessoa — ela **precisa já ter uma conta criada**
no app. A partir daí, o prontuário aparece também na lista de animais dela,
