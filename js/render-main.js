...
function renderPerfilTab(a){
  ...
  if(a.weight) highlightCards.push(`<div class="highlight-card highlight-green"><span class="hc-label">Peso</span><span class="hc-value">${escapeHtml(String(a.weight))} kg</span></div>`);
...
function renderHistoryTab(a, history){
  ...
  return `
  <div class="section-head">
    <h3>Histórico de saúde ${total>0 ? `<span class="mono" style="font-size:12.5px;font-weight:500;color:var(--ink-soft);">· total gasto: ${formatCurrency(total)}</span>` : ''}</h3>
